...
var functions = {
    getInternalUserId: function(user, privateKey) {
         ...
         */
        return crypto.createHash('md5').update(user + privateKey).digest("hex");
    },
    ...
    getRequestFields: function(request, options, callback) {
        request.body = {};
        request.query = {};
    ...
    displayError: function(req, res, options) {
        ...
        if(typeof options === 'object') {
            ...
            opts.redirectUrl = options.redirectUrl || opts.redirectUrl;
